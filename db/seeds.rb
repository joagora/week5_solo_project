...
horse1 = Horse.new({'name' => 'Magnateria', 'breed' => 'Arabian', 'owner_id' => owner1.id, 'hair_coat' => 'white'})
horse1.save
...
# training3.save
# training3 = Training.new({'horse_id' => horse2.id, 'type' => 'Dressage', 'date' => '2018-10-28', 'trainer_id' => trainer1.id, 'day_of_week' => 'Wednesday', 'duration' => 1})
# training3.save


training3 = Training.new({'horse_id' => horse2.id, 'type' => 'Show jumping', 'scheduled_date' => '2018-07-15', 'trainer_id' => trainer2.id, 'duration' => 1})

training3.save

# p Training.all()
#
# p Training.sort_by_date
training3.assign_day_of_week
